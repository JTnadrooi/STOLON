...
// -----------------------------------------------------------------
// REMOVE CRT ARCHES: disable warp, clamp UVs, and turn off bloom
// -----------------------------------------------------------------
#undef DO_BLOOM        // no more bloom halos
#define warpX  0.0    // no horizontal distortion
#define warpY  0.0    // no vertical distortion
...
{
    pos = saturate((floor(pos * texture_size.xy + off) + float2(0.5, 0.5)) / texture_size.xy);
#ifdef SIMPLE_LINEAR_GAMMA
