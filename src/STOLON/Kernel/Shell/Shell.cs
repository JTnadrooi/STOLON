...
namespace STOLON
{
    ...
    public sealed class Shell : IComponent
    {
        ...
        private TextShellRegion EnsureLastRegionIsTextRegion()
            => EnsureLastRegionIs<TextShellRegion>(() => new TextShellRegion(this, _commandManager, _logger, Font, _input, _textures));
        ...
        public void SimulateUserCommand(string command) => EnsureLastRegionIsTextRegion().SimulateUserCommand(command);
    }
}
