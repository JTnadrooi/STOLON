namespace STOLON
{
    ...
    public static class Centering
    {
        ...
        public static Vector2 GetCenter(Rectangle rectangle) => rectangle.Center.ToVector2();
        public static Vector2 GetCenter(Texture2D texture) => GetCenter(texture.Bounds);
    }
}
