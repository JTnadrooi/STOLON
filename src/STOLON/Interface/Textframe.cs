...
namespace STOLON
{
    ...
    public class Textframe : ITextframe
    {
        ...
        public void Update(int elapsedMilliseconds)
        {
            ...
            if (DialogueBounds.Contains(_input.Mouse.Position) && !_hide)
            {
            ...
            NumberHelper.PushSubunitary(ref _dialogueShowCoefficient, textFrameGoUp, elapsedMilliseconds, smoothness: 2);
