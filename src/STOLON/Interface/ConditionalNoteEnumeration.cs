namespace STOLON
{
    public class ConditionalNoteEnumeration : IComponent
    {
        ...
        public ConditionalNoteEnumeration(Vector2 pos, int textWidth, ITexture2DCollection textures, IFont2DCollection fonts)
        {
            _textures = textures;
            _fonts = fonts;
