...
namespace STOLON
{
    ...
    public abstract class Entity : IDialogueProvider, IMipmapped, IEquatable<Entity>
    {
        ...
        public Entity(string id, string name, string symbolNotation, EntityProfile profile, ConditionalNote[]? abilityNotes = null, ConditionalNote[]? allocationNotes = null, string? description = null, string? fullName = null)
        {
            Id = id;
            Name = name;
