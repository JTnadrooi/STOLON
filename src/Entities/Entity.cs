...
namespace STOLON
{
    ...
    public abstract class Entity : IDialogueProvider, IMipmapped, IEquatable<Entity>
    {
        ...
        public EntityNoteBase[] EntityNotes { get; }
        ...
        public Entity(string id, string name, string symbolNotation, EntityProfile profile, EntityNoteBase[] entityNotes, string description, string? fullName = null)
        {
            Id = id;
            Name = name;
