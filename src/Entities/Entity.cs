...
namespace STOLON
{
    ...
    public abstract class Entity : IDialogueProvider, IMipmapped, IEquatable<Entity>
    {
        ...
        public EntityNote[] EntityNotes { get; }
        ...
        public Entity(string id, string name, string symbolNotation, EntityProfile profile, EntityNote[] entityNotes, string description, string? fullName = null)
        {
            Id = id;
            Name = name;
